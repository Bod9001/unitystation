...
namespace UI
{
	...
	public class GUI_JobPreferences : MonoBehaviour
	{
		...
		{
			LocalPlayerManager.CurrentCharacterSettings.JobPreferences = jobPreferences;
			_ = ServerData.UpdateCharacterProfile(LocalPlayerManager.CurrentCharacterSettings);
		}
		...
		private void LoadJobPreferences()
		{
			...
			foreach (var jobPref in LocalPlayerManager.CurrentCharacterSettings.JobPreferences.ToList())
			{
