...
public class CablePlacementVisualisation : MonoBehaviour
{
	...
	public void OnHover()
	{
		if (!UIManager.IsMouseInteractionDisabled && LocalPlayerManager.GetActiveHandSlot() != null)
		{
			// get mouse position
			...
			if (mousePosition != lastMouseWordlPositionInt
			    && Validations.HasItemTrait(LocalPlayerManager.GetActiveHandSlot()?.ItemObject, CommonTraits.Instance.Cable))
			{
