...
namespace Antagonists
{
	...
	public abstract class Objective : ScriptableObject
	{
		...
		{
			if (aiCanHave == false && candidate.IsSilicon)
			{
				return false;
			}
		...
		{
			return CheckStorage(Owner.DynamicItemStorage, default, name) >= count;
		}

		/// <inheritdoc cref="CheckStorageFor(string, int)"/>
		protected bool CheckStorageFor(Type component, int count)
		{
			return CheckStorage(Owner.DynamicItemStorage, component, default) >= count;
		}
