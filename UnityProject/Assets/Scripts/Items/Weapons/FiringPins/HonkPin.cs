...
namespace Weapons
{
	class HonkPin : PinBase
	{
		...
		public override void ServerBehaviour(AimApply interaction, bool isSuicide)
		{
			...
			SoundManager.PlayNetworkedAtPos(CommonSounds.Instance.ClownHonk, interaction.Performer.BodyWorldPositionInt,
			hornParameters, true, sourceObj: interaction.Performer.GameObjectBody);
		}
