	...
	public class GunElectrical : Gun, ICheckedInteractable<HandActivate>
	{
		...
		private void PowerCellRemoval(InventoryApply interaction)
		{
			...
			if (bar != null)
			{
				...
				SoundManager.PlayNetworkedAtPos(CommonSounds.Instance.screwdriver, interaction.Performer.BodyWorldPosition, audioSourceParameters, sourceObj: serverHolder.GameObjectBody);
			}
		}
